...
import fr.victorLebreton.faireuneapi.feature.database.ProduitDto;
import fr.victorLebreton.faireuneapi.feature.database.ProduitWithPriceDto;
import fr.victorLebreton.faireuneapi.model.Produit;
...
class FaireUneApplicationTest {
    ...
    private Logger logger = LoggerFactory.getLogger(FaireUneApplicationTest.class);
    @Test
    void testDatabase(){
    ...
    boolean testEquality(Produit produitEntity, ProduitWithPriceDto produitWithPriceDto){
        return Objects.equals(produitEntity.getNom(), produitWithPriceDto.getNom()) && Objects.equals(produitEntity.getDescription(), produitWithPriceDto.getDescription())
    ...
    void testGetIphoneFromEntity(){
        ProduitWithPriceDto p1 = new ProduitWithPriceDto(1, "Cheese - Cheddar, Mild", "Vivamus tortor. Duis mattis egestas metus. Aenean fermentum. Donec ut mauris eget massa tempor convallis.", BigDecimal.valueOf(1.61));
